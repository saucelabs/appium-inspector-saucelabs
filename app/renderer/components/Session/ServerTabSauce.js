...
export default class ServerTabSauce extends Component {
  render () {
    ...
    const sauceUsernamePlaceholder = process.env.SAUCE_USERNAME
      ? t('usingDataFoundIn', { environmentVariable: 'SAUCE_USERNAME' })
      : t('yourUsername');

    const sauceAccessKeyPlaceholder = process.env.SAUCE_ACCESS_KEY
      ? t('usingDataFoundIn', { environmentVariable: 'SAUCE_ACCESS_KEY' })
      : t('yourAccessKey');
        ...
        <Row gutter={8}>
          <Col span={12}>
            <FormItem>
              <Input
                id="sauceUsername"
                placeholder={sauceUsernamePlaceholder}
          ...
          <Col span={12}>
            <FormItem>
              <Input
                id="saucePassword"
                type={INPUT.PASSWORD}
                placeholder={sauceAccessKeyPlaceholder}
