        ...
        <div className={SessionStyles.sessionContainer}>
          <div id="serverTypeTabs" className={SessionStyles.serverTab}>
            <Tabs
              ...
              onChange={(tab) => this.handleSelectServerTab(tab)}
            ...
            >
              {[
                ...
                <TabPane
                  tab={
                    <span className="addCloudProviderTab">
          ...
          <div className={SessionStyles.sessionFooter}>
            ...
            {!isAttaching && capsUUID && (
              <Button
                onClick={() => saveSession(caps, { uuid: capsUUID })}
                disabled={!isCapsDirty}
              >
                {t('Save')}
              </Button>
            )}
            {!isAttaching && (
              <Button onClick={requestSaveAsModal}>{t('saveAs')}</Button>
            )}
            {!isAttaching && (
              <Button
                type={BUTTON.PRIMARY}
